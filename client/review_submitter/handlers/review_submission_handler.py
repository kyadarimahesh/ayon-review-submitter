...
REVIEW_TARGET_VERSION_PRODUCT_TYPE = ["render"]
...
class ReviewSubmissionDialog(QtWidgets.QDialog):
    ...
    def _setup_ui(self):
        ...
        self.submission_type_combo.addItems(["WIP", "FINAL", "PACKAGE"])
...
class ReviewSubmissionHandler:
    ...
    def collect_review_inputs(parent, is_resubmission=False):
        ...
        if is_resubmission:
            filters = REVIEW_TARGET_VERSION_PRODUCT_TYPE
        else:
            filters = FIRST_SUBMISSION_FILTERS + REVIEW_TARGET_VERSION_PRODUCT_TYPE
        ...
        def apply_filter():
            ...
            if context:
                ...
                folder_id = folder["id"]
                task_names = INPUTS_LINKED_TASKS.copy()
